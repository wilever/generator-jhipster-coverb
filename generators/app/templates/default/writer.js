    ...
    case constant.CLIENT_FRAMEWORK.ANGULAR:
      return [
        ...
        },
        {
          ...
          TO: `${CLIENT_MAIN_SRC_DIR}content/icon/brand/faSass.d.ts`,
          METHOD: 'CONTENT',
        },
        {
          NAME: "SASS_ICON_JS",
          FROM: `${COVER_TYPE}/content/icon/brand/faSass.js`,
          TO: `${CLIENT_MAIN_SRC_DIR}content/icon/brand/faSass.js`,
          METHOD: 'CONTENT',
        },
        {
          NAME: "KEY_ICON_TS",
          FROM: `${COVER_TYPE}/content/icon/solid/faKey.d.ts`,
          TO: `${CLIENT_MAIN_SRC_DIR}content/icon/solid/faKey.d.ts`,
          METHOD: 'CONTENT',
        },
        {
          NAME: "KEY_ICON_JS",
          FROM: `${COVER_TYPE}/content/icon/solid/faKey.js`,
          TO: `${CLIENT_MAIN_SRC_DIR}content/icon/solid/faKey.js`,
          METHOD: 'CONTENT',
        },
        {
          NAME: "LANGUAGE_ICON_TS",
          FROM: `${COVER_TYPE}/content/icon/solid/faLanguage.d.ts`,
          TO: `${CLIENT_MAIN_SRC_DIR}content/icon/solid/faLanguage.d.ts`,
          METHOD: 'CONTENT',
        },
        {
          NAME: "LANGUAGE_ICON_JS",
          FROM: `${COVER_TYPE}/content/icon/solid/faLanguage.js`,
          TO: `${CLIENT_MAIN_SRC_DIR}content/icon/solid/faLanguage.js`,
          METHOD: 'CONTENT',
        },
        {
          NAME: "LOCK_OPEN_ICON_TS",
          FROM: `${COVER_TYPE}/content/icon/solid/faLockOpen.d.ts`,
          TO: `${CLIENT_MAIN_SRC_DIR}content/icon/solid/faLockOpen.d.ts`,
          METHOD: 'CONTENT',
        },
        {
          NAME: "LOCK_OPEN_ICON_JS",
          FROM: `${COVER_TYPE}/content/icon/solid/faLockOpen.js`,
          TO: `${CLIENT_MAIN_SRC_DIR}content/icon/solid/faLockOpen.js`,
          METHOD: 'CONTENT',
        },
        {
          NAME: "MAGIC_ICON_TS",
          FROM: `${COVER_TYPE}/content/icon/solid/faMagic.d.ts`,
          TO: `${CLIENT_MAIN_SRC_DIR}content/icon/solid/faMagic.d.ts`,
          METHOD: 'CONTENT',
        },
        {
          NAME: "MAGIC_ICON_JS",
          FROM: `${COVER_TYPE}/content/icon/solid/faMagic.js`,
          TO: `${CLIENT_MAIN_SRC_DIR}content/icon/solid/faMagic.js`,
          METHOD: 'CONTENT',
        },
        {
          NAME: "PALETTE_ICON_TS",
          FROM: `${COVER_TYPE}/content/icon/solid/faPalette.d.ts`,
          TO: `${CLIENT_MAIN_SRC_DIR}content/icon/solid/faPalette.d.ts`,
          METHOD: 'CONTENT',
        },
        {
          NAME: "PALETTE_ICON_JS",
          FROM: `${COVER_TYPE}/content/icon/solid/faPalette.js`,
          TO: `${CLIENT_MAIN_SRC_DIR}content/icon/solid/faPalette.js`,
          METHOD: 'CONTENT',
        },
      ];
