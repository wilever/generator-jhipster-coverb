...
export class DefaultTest extends Component {
  render() {
    return (
      <div>
        <section id="default-test">
          <div className="jumbotron text-center">
            <h1>
              <Translate contentKey="default-test.title">What is coverb?</Translate>
            </h1>
            <p>
              <Translate contentKey="default-test.description">It is a page generator for jhipster application</Translate>
            </p>
          </div>
          <div className="container-fluid text-center">
            <h2>
              <Translate contentKey="default-test.feature.title">Features</Translate>
            </h2>
            <p>
              <Translate contentKey="default-test.feature.description">What we offer?</Translate>
            </p>
            <br />
            <Row>
              <Col sm="4">
          ...
          <div className="container-fluid text-center bg-gray">
            <h2>
              <Translate contentKey="default-test.portafolio.title">Portafolio</Translate>
            </h2>
            <p>
              <Translate contentKey="default-test.portafolio.description">What did we already created?</Translate>
            </p>
            <br />
            <Row>
              <Col sm="6">
